...
USAGE: $(basename $0)  <stonename> <gemstone-version> <software-branch> <frameworkversion>
Creates a new initial server - without loading application specific stuff. So only the framework version is
loaded

EXAMPLES
  $(basename $0) sts 3.5.1 develop|production v71
